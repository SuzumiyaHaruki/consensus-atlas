...
func main() {
	...
	fmt.Printf("qualified=%t required=%d validated=%d/%d unsupported=%d digest=%s\n",
		bundle.Qualification.Qualified,
		bundle.Qualification.Summary.Required,
		bundle.Qualification.Summary.Validated,
		bundle.Qualification.Summary.Total,
		bundle.Qualification.Summary.Unsupported,
		bundle.Digest,
	)
}
